...
`plugins/asbarron-pr-review/agents/reviewer.md` defines tone, taxonomy, and calibration rules. Changes here affect every review the skill produces. Be conservative — the rules exist to prevent review fatigue.
